  ...
  return (
    <AppLayout>
      <div className="py-8">
        ...
        <div className="mt-12">
          <button 
            className="w-full flex items-center justify-center p-4 bg-purple-50 hover:bg-purple-100 rounded-lg shadow-sm transition-colors"
            onClick={() => {
              const guiaCompleta = document.getElementById('guia-completa-listas');
              if (guiaCompleta) guiaCompleta.style.display = guiaCompleta.style.display === 'none' ? 'block' : 'none';
            }}
          >
            <span className="text-purple-700 font-medium mr-2">¿Nuevo por aquí? Ver guía de uso</span>
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-purple-600" viewBox="0 0 20 20" fill="currentColor">
              <path fillRule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clipRule="evenodd" />
            </svg>
          </button>
          
          <div id="guia-completa-listas" className="mt-4 hidden bg-purple-50 border-l-4 border-purple-500 p-4 rounded shadow-sm">
