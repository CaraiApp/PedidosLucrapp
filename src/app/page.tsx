  ...
  return (
    <div className="bg-white">
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-blue-600 to-indigo-700">
        ...
        >
          <div
            className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-blue-300 to-indigo-400 opacity-20 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
            style={{
              clipPath:
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            ...
            <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
              Todo lo que necesitas para gestionar tus pedidos a proveedores
            </p>
            <p className="mt-6 text-lg leading-8 text-gray-600">
              LucrApp te permite crear listas de compras, gestionar proveedores
              y artículos, y automatizar el proceso de pedidos, todo desde una
          ...
          <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
            <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
              <div className="flex flex-col">
                ...
                <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600">
                  <p className="flex-auto">
                    Crea y gestiona tus listas de compra de forma rápida y
                    sencilla. Organiza tus pedidos por proveedor y mantén un
              ...
              <div className="flex flex-col">
                ...
                <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600">
                  <p className="flex-auto">
                    Mantén un catálogo completo de todos tus productos con
                    precios actualizados. Asocia cada artículo con su proveedor
                    correspondiente.
                  </p>
                </dd>
              </div>
              <div className="flex flex-col">
                ...
                <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600">
                  <p className="flex-auto">
                    Centraliza toda la información de tus proveedores.
                    Contactos, catálogos y pedidos, todo en un solo lugar.
                  </p>
                </dd>
              </div>
            </dl>
          ...
          <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-3">
            <div className="flex flex-col bg-white p-6 shadow-lg rounded-lg">
              ...
              <p className="mt-6 text-base leading-7 text-gray-600">
                "Desde que utilizamos LucrApp, hemos reducido el tiempo que
                dedicamos a gestionar pedidos en un 70%. La capacidad de
                organizar todo por proveedores nos ha ayudado a optimizar
                nuestras compras."
              </p>
            </div>
            <div className="flex flex-col bg-white p-6 shadow-lg rounded-lg">
              ...
              <p className="mt-6 text-base leading-7 text-gray-600">
                "LucrApp ha sido un cambio radical para nuestro negocio. Ahora
                puedo enviar pedidos directamente a mis proveedores con un solo
                clic, y llevar un control preciso de todos mis productos."
              </p>
            </div>
            <div className="flex flex-col bg-white p-6 shadow-lg rounded-lg">
              <div className="flex items-center gap-x-4">
              ...
              <p className="mt-6 text-base leading-7 text-gray-600">
                "La posibilidad de tener diferentes listas para cada proveedor y
                poder llevar un historial de pedidos ha sido fundamental para
                mejorar nuestra logística y reducir costes."
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
              Planes para todos los negocios
            </p>
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Elige el plan que mejor se adapte a tus necesidades. Todos
              incluyen acceso completo a la plataforma.
            </p>
          </div>
          <div className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
            <div className="p-8 sm:p-10 lg:flex-auto">
              ...
              <p className="mt-6 text-base leading-7 text-gray-600">
                Gestiona tus pedidos y proveedores con todas las funcionalidades
                de LucrApp. Incluye soporte técnico y actualizaciones gratuitas.
              </p>
              ...
              <ul className="mt-8 grid grid-cols-1 gap-4 text-sm leading-6 text-gray-600 sm:grid-cols-2 sm:gap-6">
                ...
                <li className="flex gap-x-3">
                  ...
                  Gestión de hasta 50 proveedores
                </li>
                <li className="flex gap-x-3">
                  <svg
                    className="h-6 w-5 flex-none text-indigo-600"
                  ...
                  Catálogo de hasta 1000 artículos
                </li>
                <li className="flex gap-x-3">
                  <svg
                    className="h-6 w-5 flex-none text-indigo-600"
                ...
                <li className="flex gap-x-3">
                  ...
                  Envío de pedidos por WhatsApp y email
                </li>
                <li className="flex gap-x-3">
                  <svg
                    className="h-6 w-5 flex-none text-indigo-600"
              ...
              <div className="rounded-2xl bg-gray-50 py-10 text-center ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16">
                <div className="mx-auto max-w-xs px-8">
                  ...
                  <p className="mt-6 text-xs leading-5 text-gray-600">
                    También disponible plan gratuito limitado. Facturas e IVA
                    incluido.
                  </p>
                </div>
              </div>
        ...
        <div className="py-24 px-6 sm:px-6 sm:py-32 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">
              Simplifica tus pedidos a proveedores hoy mismo
            </h2>
            <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-indigo-200">
              Prueba LucrApp gratis durante 14 días y descubre cómo puede
              ayudarte a gestionar tus proveedores de manera más eficiente.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
          ...
          <div className="mt-8 md:order-1 md:mt-0">
            <p className="text-center text-xs leading-5 text-gray-500">
              &copy; {new Date().getFullYear()} LucrApp. Todos los derechos
              reservados.
            </p>
          </div>
        </div>
